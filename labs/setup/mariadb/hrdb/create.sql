...
alter table employees add constraint employee_job_fk foreign key ( job_id ) references jobs ( job_id );
alter table employees add constraint employee_employee_fk foreign key ( manager_id ) references employees ( employee_id );
alter table employees add constraint employee_department_fk foreign key (department_id) references departments ( department_id );
